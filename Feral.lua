local Xe 								= Xe
local TeamCache 							= Xe.TeamCache
local EnemyTeam 							= Xe.EnemyTeam
local FriendlyTeam 							= Xe.FriendlyTeam
local LoC 									= Xe.LossOfControl
local Player 								= Xe.Player 
local MultiUnits 							= Xe.MultiUnits
local UnitCooldown 							= Xe.UnitCooldown
local Unit 									= Xe.Unit 

local setmetatable							= setmetatable

Xe[Xe_CONST_DRUID_FERAL] 			= {
    -- Racial
    ArcaneTorrent							= Xe.Create({ Type = "Spell", ID = 50613}),
    BloodFury								= Xe.Create({ Type = "Spell", ID = 20572}),
    Fireblood								= Xe.Create({ Type = "Spell", ID = 265221}),
    AncestralCall							= Xe.Create({ Type = "Spell", ID = 274738}),
    Berserking								= Xe.Create({ Type = "Spell", ID = 26297}),
    ArcanePulse								= Xe.Create({ Type = "Spell", ID = 260364}),
    QuakingPalm								= Xe.Create({ Type = "Spell", ID = 107079}),
    Haymaker								= Xe.Create({ Type = "Spell", ID = 287712}), 
    BullRush								= Xe.Create({ Type = "Spell", ID = 255654}),    
    WarStomp								= Xe.Create({ Type = "Spell", ID = 20549}),
    GiftofNaaru								= Xe.Create({ Type = "Spell", ID = 59544}),
    Shadowmeld								= Xe.Create({ Type = "Spell", ID = 58984}), -- usable in Xe Core 
    Stoneform								= Xe.Create({ Type = "Spell", ID = 20594}), 
    WilloftheForsaken						= Xe.Create({ Type = "Spell", ID = 7744}), -- not usable in APL but user can Queue it    
    EscapeArtist							= Xe.Create({ Type = "Spell", ID = 20589}), -- not usable in APL but user can Queue it
    EveryManforHimself						= Xe.Create({ Type = "Spell", ID = 59752}), -- not usable in APL but user can Queue it
	
	
	
	-- Crowd Control
	CastBarsInterrupt						= Xe.Create({ Type = "Spell", ID = 106839, Desc = "[CastBars] Interrupt", QueueForbidden = true, BlockForbidden = true}), -- SkullBash 
	EntanglingRoots							= Xe.Create({ Type = "Spell", ID = 339}),
	SkullBash								= Xe.Create({ Type = "Spell", ID = 106839}),
	WildChargeRed							= Xe.Create({ Type = "SpellSingleColor", ID = 102401, Color = "RED", Desc = "[1] CC Focus"}), 
	MightyBashGreen							= Xe.Create({ Type = "SpellSingleColor", ID = 5211, Color = "GREEN", Desc = "[1] CC Focus", isTalent = true}), 
	CycloneFocus							= Xe.Create({ Type = "Spell", ID = 33786, Desc = "[1] CC Focus", isTalent = true}), 
	SkullBashGreen							= Xe.Create({ Type = "SpellSingleColor", ID = 106839, Color = "GREEN", Desc = "[2] Kick", QueueForbidden = true}),

	-- Suppotive 
	AbissalHealing							= Xe.Create({ Type = "Item", ID = 169451, QueueForbidden = true}),
	Regrowth								= Xe.Create({ Type = "Spell", ID = 8936}),
	Soothe									= Xe.Create({ Type = "Spell", ID = 2908}),
	RemoveCorruption						= Xe.Create({ Type = "Spell", ID = 2782}),
	SurvivalInstincts						= Xe.Create({ Type = "Spell", ID = 61336}),
	-- Spells
	CatForm									= Xe.Create({ Type = "Spell", ID = 768}),
	BearForm								= Xe.Create({ Type = "Spell", ID = 5487}),
	TravelForm								= Xe.Create({ Type = "Spell", ID = 783}),
    Prowl									= Xe.Create({ Type = "Spell", ID = 5215}),
    Berserk									= Xe.Create({ Type = "Spell", ID = 106951}),
	Rake									= Xe.Create({ Type = "Spell", ID = 1822}),
	ThrashCat								= Xe.Create({ Type = "Spell", ID = 106830}),
	SwipeCat								= Xe.Create({ Type = "Spell", ID = 106785}),
	MoonfireCat								= Xe.Create({ Type = "Spell", ID = 155625}),
	Shred									= Xe.Create({ Type = "Spell", ID = 5221}),
	Rip										= Xe.Create({ Type = "Spell", ID = 1079}),
	TigersFury								= Xe.Create({ Type = "Spell", ID = 5217}),
	FerociousBite							= Xe.Create({ Type = "Spell", ID = 22568}),
	Maim									= Xe.Create({ Type = "Spell", ID = 22570}),    
	-- Buffs
	PredatorySwiftnessBuff					= Xe.Create({ Type = "Spell", ID = 69369, Hidden = true}),
	BloodtalonsBuff							= Xe.Create({ Type = "Spell", ID = 145152, Hidden = true}),
	ScentofBloodBuff						= Xe.Create({ Type = "Spell", ID = 285646, Hidden = true}),
	TigersFuryBuff							= Xe.Create({ Type = "Spell", ID = 5217, Hidden = true}),
	IncarnationBuff							= Xe.Create({ Type = "Spell", ID = 102543, Hidden = true}),
	BerserkBuff								= Xe.Create({ Type = "Spell", ID = 106951, Hidden = true}),
	ClearcastingBuff						= Xe.Create({ Type = "Spell", ID = 135700, Hidden = true}),
	ProwlBuff								= Xe.Create({ Type = "Spell", ID = 5215, Hidden = true}),
	-- Debuffs
	RakeDebuff								= Xe.Create({ Type = "Spell", ID = 155722, Hidden = true}),
	ThrashCatDebuff							= Xe.Create({ Type = "Spell", ID = 106830, Hidden = true}),
	MoonfireCatDebuff						= Xe.Create({ Type = "Spell", ID = 155625, Hidden = true}),
	RipDebuff								= Xe.Create({ Type = "Spell", ID = 1079, Hidden = true}),
	ConcentratedFlameDebuff					= Xe.Create({ Type = "Spell", ID = 295368, Hidden = true}),
	-- Trinkets
	PocketsizedComputationDevice			= Xe.Create({ Type = "Trinket", ID = 167555, QueueForbidden = true}),
	
	--Talents
	Predator								= Xe.Create({ Type = "Spell", ID = 202021, isTalent = true}), 	-- Talent 1/1
	Sabertooth								= Xe.Create({ Type = "Spell", ID = 202031, isTalent = true}), 	-- Talent 1/2
	LunarInspiration						= Xe.Create({ Type = "Spell", ID = 155580, isTalent = true}), 	-- Talent 1/3
	WildCharge								= Xe.Create({ Type = "Spell", ID = 102401, isTalent = true}), 	-- Talent 2/3
	BalanceAffinity							= Xe.Create({ Type = "Spell", ID = 197488, isTalent = true}), 	-- Talent 3/1
	MightyBash								= Xe.Create({ Type = "Spell", ID = 5211, isTalent = true}), 	-- Talent 4/1
	Typhoon									= Xe.Create({ Type = "Spell", ID = 132469, isTalent = true}),	-- Talent 4/3
	ScentofBlood							= Xe.Create({ Type = "Spell", ID = 285564, isTalent = true}), 	-- Talent 6/1
	BrutalSlash								= Xe.Create({ Type = "Spell", ID = 202028, isTalent = true}), 	-- Talent 6/2
	PrimalWrath								= Xe.Create({ Type = "Spell", ID = 285381, isTalent = true}), 	-- Talent 6/3
	Bloodtalons								= Xe.Create({ Type = "Spell", ID = 155672, isTalent = true}), 	-- Talent 7/2
	FeralFrenzy								= Xe.Create({ Type = "Spell", ID = 274837, isTalent = true}), 	-- Talent 7/3
	Thorns									= Xe.Create({ Type = "Spell", ID = 236696, isTalent = true}), 	-- PvP Talent
	--Hidden
	RepeatPerformanceDebuff					= Xe.Create({ Type = "Spell", ID = 301244, Hidden = true}), -- Queens Court - Repeat Performance debuff
	WildChargeCat							= Xe.Create({ Type = "Spell", ID = 49376, Hidden = true}),	
	WildFleshRending						= Xe.Create({ Type = "Spell", ID = 279527, Hidden = true}), -- Simcraft Azerite
	JungleFury								= Xe.Create({ Type = "Spell", ID = 274424, Hidden = true}), -- Simcraft Azerite
	CyclotronicBlast						= Xe.Create({ Type = "Spell", ID = 293491, Hidden = true}),
	Channeling								= Xe.Create({ Type = "Spell", ID = 209274, Hidden = true}),	
	
}
Xe:CreateEssencesFor(Xe_CONST_DRUID_FERAL)
local A 									= setmetatable(Xe[Xe_CONST_DRUID_FERAL], { __index = Xe })
...
function TrinketIsAllowed()
	...
	local Trinket2IsAllowed = true
   	    ...
   	    for i = 1, #BlackListedTrinkets do
            if Xe.Trinket1.ID == BlackListedTrinkets[i] then
                Trinket1IsAllowed = false				
			end
            if Xe.Trinket2.ID == BlackListedTrinkets[i] then
...
function Xe:IsEnoughEnergy(energy, saveEnergy)
    -- @return boolean 
...
local function SelfDefensives()
	...
	if A.AbissalHealing:IsReady(player) and  AbyssalPot >= 0 and ((AbyssalPot >= 100 and Unit(player):TimeToDie() <= 4 and Unit(player):HealthPercent() <= 30) or
...
A[3] = function(icon)
	...
	local refreshTime							= (A.GetGCD() + A.GetCurrentGCD() + A.GetPing() + (TMW.UPD_INTV or 0) + Xe_CONST_CACHE_DEFAULT_TIMER)
	...
	local TrinketON								= ((Xe.GetToggle(1, "Trinkets")[1]) or (Xe.GetToggle(1, "Trinkets")[2]))
	...
	local function Enemy(unitID)
		...
		if Temp.OpenerRotation and Unit(unitID):GetRange() <= openerDistance and canCast then 
			...
			if A.TigersFury:IsReadyByPassCastGCD(player, nil, nil, true) and canCast then
			...
			Unit(unitID):HasDeBuffs(A.RipDebuff.ID, true) == 0 then
				return A.PrimalWrath:Show(icon)
			end
			
			if A.Rip:IsReady(unitID) and A.Rip:AbsentImun(unitID, Temp.AttackTypes) and canCast and Unit(unitID):HasDeBuffs(A.RipDebuff.ID, true) == 0 and ((inAoe and MultiUnits:GetByRange(inAoERanged, 2) < 2) or not inAoe) then
			...
			if Unit(unitID):HasDeBuffs(A.RipDebuff.ID, true) > 0 and (isWildFleshRending and Unit(unitID):HasDeBuffs(A.ThrashCatDebuff.ID) > 0 or not isWildFleshRending) then 
	...
	--	
		...
		(not A.IsInPvP or (A.IsInPvP and Unit(unitID):HasDeBuffs("Stuned") >= A.GetGCD() * 3)) then
			...
			if A.GuardianofAzeroth:AutoHeartOfAzerothP(unitID) and canCast and Unit(unitID):HasDeBuffs(A.RipDebuff.ID, true) > 0 and Unit(player):HasBuffs(A.TigersFuryBuff.ID, true) > 0 and canCast then 
			...
			if A.PocketsizedComputationDevice:IsReady(unitID) and A.PocketsizedComputationDevice:AbsentImun(unitID, "DamageMagicImun") and TrinketON and 
			Unit(player):HasBuffs(A.TigersFuryBuff.ID, true) > 0 and A.JungleFury:GetAzeriteRank() >= 1 and Unit(unitID):HasDeBuffs(A.RipDebuff.ID, true) > 15 and canCast then
				return A.PocketsizedComputationDevice:Show(icon)
			end
		...
		if A.TigersFury:IsReadyByPassCastGCD(player, nil, nil, true) and InMelee(unitID) and canCast and not Temp.OpenerRotation and 
		(Player:EnergyDeficitPredicted() >= 60 or (A.Predator:IsSpellLearned() and MultiUnits:GetByRange(inAoERanged, 2) > 1)) then
			return A.TigersFury:Show(icon)
		end
		...
		and Unit(unitID):HasDeBuffs(A.RipDebuff.ID, true) > 0 and Unit(unitID):HasDeBuffs(A.RakeDebuff.ID, true, true) > 0 and canCast then 
            return A.ConcentratedFlame:Show(icon)
        end 
		
		if A.FocusedAzeriteBeam:AutoHeartOfAzeroth(unitID) and canCast and (((MultiUnits:GetByRange(10, minHoldAoE) >= minHoldAoE and inHoldAoE) or 
		(not inHoldAoE and MultiUnits:GetByRange(10, 2) > 1)) or Unit(unitID):IsBoss()) and not Unit(unitID):IsExplosives() then 
			return A.FocusedAzeriteBeam:Show(icon)
        end 
		
		if A.BloodoftheEnemy:AutoHeartOfAzerothP(unitID) and Unit(player):HasBuffs(A.TigersFuryBuff.ID, true) > 0 and not inStealth and canCast and
		(((MultiUnits:GetByRange(10, minHoldAoE) >= minHoldAoE and inHoldAoE) or (not inHoldAoE and MultiUnits:GetByRange(10, 2) > 1)) or 
		Unit(unitID):IsBoss()) and not Unit(unitID):IsExplosives() then 
			return A.BloodoftheEnemy:Show(icon)   
		end
		
		if A.ReapingFlames:AutoHeartOfAzerothP(unitID) and not inStealth and canCast and (Unit(unitID):HealthPercent() < 20 or Unit(unitID):HealthPercent() > 80) then
			return A.ReapingFlames:Show(icon)
		end
		
		if A.WorldveinResonance:AutoHeartOfAzerothP(unitID) and not inStealth and canCast then
		...
		if CP == CP_MAX and not Temp.OpenerRotation and Unit(player):HasBuffs(A.CatForm.ID, true) > 0 then	
			...
			inAoE and MultiUnits:GetByRange(inAoERanged, 2) > 1 and (Unit(unitID):HasDeBuffs(A.RipDebuff.ID, true) < 4 or MultiUnits:GetByRangeMissedDoTs(inAoERanged, 1, A.RipDebuff.ID, 10) >= 1)
			and not Unit(unitID):IsExplosives() then
				return A.PrimalWrath:Show(icon)
			end
			
			if A.PrimalWrath:IsReady(unitID, true) and InMelee(unitID) and A.PrimalWrath:AbsentImun(unitID, Temp.AttackTypes) and canCast and 
			inAoE and MultiUnits:GetByRange(inAoERanged, 3) > 2 and not Unit(unitID):IsExplosives() then
				return A.PrimalWrath:Show(icon)
			end
		
			if A.Rip:IsReady(unitID) and A.Rip:AbsentImun(unitID, Temp.AttackTypes) and canCast and (Unit(unitID):HasDeBuffs(A.RipDebuff.ID, true) == 0 or 
			(Unit(unitID):HasDeBuffs(A.RipDebuff.ID, true) <= refreshTime) and (not A.Sabertooth:IsSpellLearned()) or (Unit(unitID):HasDeBuffs(A.RipDebuff.ID) <= refreshTime and 
			A.Persistent_PMultiplier(A.Rip.ID) > A.PMultiplier(unitID, A.Rip.ID))) and not Unit(unitID):IsExplosives() then -- and Unit(unitID):TimeToDie() > 8
				return A.Rip:Show(icon)
			end
			...
			if A.FerociousBite:IsReady(unitID) and A.FerociousBite:AbsentImun(unitID, Temp.AttackTypes) and canCast and (Unit(unitID):HasDeBuffs(A.RipDebuff.ID) > 0) then
				if Unit(player):HasBuffs(A.IncarnationBuff.ID, true) > 0 or Unit(player):HasBuffs(A.BerserkBuff.ID, true) > 0 and not Unit(unitID):IsExplosives() then
		...
		if CP < CP_MAX then
			...
			inAoE and MultiUnits:GetByRange(inAoERanged, 2) > 1 and (Unit(unitID):HasDeBuffs(A.ThrashCatDebuff.ID) > 0 and isWildFleshRending or not isWildFleshRending) and not 
			Unit(unitID):IsExplosives() then 
			...
			and Unit(player):HasBuffs(A.BloodtalonsBuff.ID, true) == 0) and inAoE and MultiUnits:GetByRange(inAoERanged, 4) > 3 and not Unit(unitID):IsExplosives() then 
				return A.ThrashCat:Show(icon) 
			end
			...
			Unit(player):HasBuffs(A.ScentofBloodBuff.ID, true) > 0 and not Unit(unitID):IsExplosives() then
			...
			and Unit(unitID):TimeToDie() > 4) and (inAoe and MultiUnits:GetByRange(inAoERanged, 6) < 6 or not inAoe) and not Unit(unitID):IsExplosives() then
				return A.Rake:Show(icon)
			end
			...
			(Unit(player):HasBuffs(A.BloodtalonsBuff.ID, true) > 0 and Unit(player):HasBuffs(A.PredatorySwiftnessBuff.ID, true) == 0) and not Unit(unitID):IsExplosives() then
			...
			A.BrutalSlash:GetSpellChargesFullRechargeTime() < 18.5) and Unit(player):HasBuffs(A.ClearcastingBuff.ID, true) == 0 and not Unit(unitID):IsExplosives() then
				return A.BrutalSlash:Show(icon) 
			end
			
			--moonfire_cat,target_if=refreshable
			if A.MoonfireCat:IsReady(unitID) and A.MoonfireCat:AbsentImun(unitID, Temp.AttackTypes) and canCast and A.LunarInspiration:IsSpellLearned() and 
			Unit(unitID):HasDeBuffs(A.MoonfireCatDebuff.ID) <= refreshTime and not Unit(unitID):IsExplosives() then
				return A.MoonfireCat:Show(icon) 
			end	
			...
			(Unit(unitID):HasDeBuffs(A.ThrashCatDebuff.ID) <= 4 and (isWildFleshRending or (inAoE and MultiUnits:GetByRange(inAoERanged, 2) > 1))) and not Unit(unitID):IsExplosives() then
				return A.ThrashCat:Show(icon) 
			end
			...
			if A.ThrashCat:IsReady(unitID, true) and A.ThrashCat:AbsentImun(unitID, Temp.AttackTypes) and InMelee(unitID) and canCast and Unit(player):HasBuffs(A.BloodtalonsBuff.ID, true) == 0 and
			(Unit(unitID):HasDeBuffs(A.ThrashCatDebuff.ID) <= 4 and isWildFleshRending and Unit(player):HasBuffsStacks(A.ClearcastingBuff.ID, true)) and not Unit(unitID):IsExplosives() then
				return A.ThrashCat:Show(icon) 
			end
			...
			--shred,if=dot.rake.remains>(Xe.shred.cost+Xe.rake.cost-energy)%energy.regen|buff.clearcasting.react
			...
			Unit(player):HasBuffs(A.BloodtalonsBuff.ID, true) > 0) or not isWildFleshRending) and not Unit(unitID):IsExplosives() then
...
local function ArenaRotation(icon, unitID)
    if A.IsInPvP and (A.Zone == "pvp" or A.Zone == "arena") and not Player:IsStealthed() and not Player:IsMounted() then     
		...
		if Player:ComboPoints() == Player:ComboPointsMax() then
			if A.Rip:IsReady(unitID) and A.Rip:AbsentImun(unitID, Temp.AttackTypes) and Unit(unitID):HasDeBuffs(A.RipDebuff.ID, true) <= A.GetGCD() + A.GetCurrentGCD() and 
