...
Action[ACTION_CONST_DRUID_FERAL] 			= {
	...
	-- Crowd Control
	CastBarsInterrupt						= Action.Create({ Type = "Spell", ID = 106839, Desc = "[CastBars] Interrupt", QueueForbidden = true, BlockForbidden = true}), -- SkullBash 
	...
	--Talents
	Predator								= Action.Create({ Type = "Spell", ID = 202021, isTalent = true}), 	-- Talent 1/1
